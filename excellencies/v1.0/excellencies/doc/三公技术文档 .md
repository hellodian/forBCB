...
举例说明：从0时开始算起，23时是最高投注为100dc且获胜,23.40时另外投注玩家投注110dc，且获胜，那么此时，起始时间置位0，重新开始计算，直到24小时内没有玩家超过他的下注，24小时到点后，将奖池的一半派奖给110dc的投注玩家。这个24小时返奖接口，是游戏平台记录数据并调用的的，合约只负责校验和执行转币操作。
